<?php
class SplBitArrayTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetNextSet5()
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            $array  = new SplBitArray(mt_rand(1, 100));
            $numSet = mt_rand(0, 19);
